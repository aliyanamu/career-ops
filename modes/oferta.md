...
Read `cv.md`. Create a table with each JD requirement mapped to exact lines of the CV.
...
Table with data and cited sources. If there's no data, say so instead of inventing it.
