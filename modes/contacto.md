...
3. **Select the primary target**: the person who would benefit most from having the candidate there
...
4. **Generate the message** with a 3-sentence framework adapted to the contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: A specific challenge their team is facing (pulled from the JD, company blog, or news)
   - **Sentence 2 (Proof)**: The candidate's biggest quantifiable achievement that shows they have solved similar problems
   ...
   - **Sentence 1 (Research)**: A reference to something specific from their work or background
...
6. **Alternative targets** with a rationale for why they are good second choices
